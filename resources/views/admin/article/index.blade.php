    ...
    <div class="bg-white shadow-md sm:rounded-lg overflow-hidden">
        <div class="p-3 sm:p-4">
            ...
            <p class="mt-1 text-sm text-gray-500">
                Manage all news articles and services here.
            </p>
        </div>
            ...
            <div class="w-full sm:w-1/2">
                {{-- <form class="flex items-center">
                    ...
                    <div class="relative w-full">
                        <input type="text" id="simple-search" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5" placeholder="Cari artikel...">
                    </div>
                </form> --}}
            </div>
            <div
            ...
            <table class="w-full text-xs sm:text-sm text-left text-gray-500">
                <thead class="text-xs text-gray-700 uppercase bg-gray-50">
                    <tr>
                        ...
                        <th scope="col" class="px-3 sm:px-6 py-2 sm:py-3">Headline</th>
                        <th scope="col" class="hidden sm:table-cell px-3 sm:px-6 py-2 sm:py-3">Date Created</th>
                        <th scope="col" class="px-3 sm:px-6 py-2 sm:py-3 text-right">Action</th>
                    </tr>
                </thead>
                <tbody>
                        ...
                        <tr class="bg-white border-b hover:bg-gray-50">
                            ...
                            <td class="px-3 sm:px-6 py-3 sm:py-4 font-medium text-gray-900">
                                <div class="flex flex-col">
                                    ...
                                    <span
                                        class="sm:hidden text-xs text-gray-500 mt-1">{{ $article->created_at->format('d M Y') }}</span>
                                </div>
                            </td>
                                        ...
                                        <div x-show="open" @click.away="open = false"
                                            ...
                                            <div class="bg-white rounded-lg shadow-lg p-4 sm:p-6 w-full max-w-md">
                                                <h3 class="text-lg font-semibold text-gray-900">
                                                    Confirmation of Deletion</h3>
                                                <p class="mt-2 text-sm text-gray-600">Are you sure you want to delete
                                                    this article? This action cannot be undone.</p>
                                                <div
