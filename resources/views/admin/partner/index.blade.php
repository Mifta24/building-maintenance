    ...
    <div class="bg-white shadow-md sm:rounded-lg overflow-hidden">
        <div class="p-3 sm:p-4">
            ...
            <p class="mt-1 text-sm text-gray-500">
                Manage all news and service partners here.
            </p>
        </div>
            ...
            <div class="w-full sm:w-1/2">
                {{-- <form class="flex items-center">
                    ...
                    <div class="relative w-full">
                        <input type="text" id="simple-search" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5" placeholder="Search for partners...">
                    </div>
                </form> --}}
            </div>
            <div
                        ...
                        <tr class="bg-white border-b hover:bg-gray-50">
                            ...
                            <td class="px-3 sm:px-6 py-3 sm:py-4 font-medium text-gray-900">
                                <div class="flex flex-col">
                                    ...
                                    <span
                                        class="sm:hidden text-xs text-gray-500 mt-1">{{ $partner->created_at->format('d M Y') }}</span>
                                </div>
                            </td>
                                        ...
                                        <div x-show="open" @click.away="open = false"
                                            ...
                                            <div class="bg-white rounded-lg shadow-lg p-4 sm:p-6 w-full max-w-md">
                                                ...
                                                <p class="mt-2 text-sm text-gray-600">Are you sure
                                                    you want to delete this partner? This action cannot be
                                                    undone.</p>
                                                <div
